...
public class ViewLatestMessageWithoutSomeMessagesUseCase
		extends UseCase<ViewLatestMessageWithoutSomeMessagesUseCase.InputValues, ViewLatestMessageWithoutSomeMessagesUseCase.OutputValues> {
